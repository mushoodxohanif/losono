...
ALTER TABLE "crm_integrations" ALTER COLUMN "connected_at" DROP DEFAULT;--> statement-breakpoint
ALTER TABLE "crm_integrations" ALTER COLUMN "connected_at" DROP NOT NULL;--> statement-breakpoint
ALTER TABLE "crm_integrations" ADD COLUMN "sales_crm_base_url" text;